  			...
  			'<div class="ion-place-tools-map-holder" ng-class="{ \'visible\': visible }">',
  				'<div class="ion-place-tools-map-wrapper">',
	  				...
	  				'<div class="autocomplete-wrap">',
	  					'<ion-google-place radius="options.radius" class="text-black" placeholder="Your address" location-changed="locationChanged" ng-model="data.address" required name="address"/><i class="icon ion-android-locate fs-32 placeholder-icon" style="width: 44px; right: 48px !important;"></i>',
	  				'</div>',
	  				'<div class="controls">',
